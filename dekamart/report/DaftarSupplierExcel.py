...
# SINTAKS INI UTK MENDOWNLOAD PRINT REPORTS SUPPLIER KE REPO LOCAL XLSX
class PartnerXlsx(models.AbstractModel):
    _name = 'report.dekamart.report_supplier_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, supplier):
        ...
        sheet.write(0, 0, str(self.tgl_lap))  # TANGGAL
